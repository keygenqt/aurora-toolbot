...
export const emulator_package_run = {
    ...
    emulator_package_run_by_id: async function (is_listen, id) {
        return AppUtils.checkResponse(await invoke("emulator_package_run_by_id", { isListen: is_listen, id: id }));
    },
    emulator_package_run_package: async function (is_listen, package_name) {
        return AppUtils.checkResponse(await invoke("emulator_package_run_package", { isListen: is_listen, package: package_name }));
    },
    emulator_package_run_package_by_id: async function (is_listen, package_name, id) {
        return AppUtils.checkResponse(await invoke("emulator_package_run_package_by_id", { isListen: is_listen, package: package_name, id: id }));
    }
}
